...
```python
r_check_pkgs(base_pkg_list, remote_repos, pkgs, versions, all)
```
...
<table class="table table-condensed table-bordered table-params">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p><code>List of strings; optional</code></p>
        <p>List of packages to be checked against the supplied base_pkg_list. For runtime overrides, use bazel run [target] -- -p [comma-separated-list-of-packages]</p>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <p><code>List of strings; optional</code></p>
        <p>Desired package versions. For runtime overrides, use bazel run [target] -- -p [comma-separated-list-of-packages] -v [comma-separated-list-of-versions]</p>
      </td>
    </tr>    
    <tr>
      <td><code>all</code></td>
      <td>
        ...
        <p>Update all packages present in the specified <code>base_pkg_list</code>. For runtime overrides, use bazel run [target] -- -a</p>
      </td>
    </tr>
